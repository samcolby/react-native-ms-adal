...
{
  NSMutableDictionary *dict = (obj.status == AD_SUCCEEDED) ? [RNAdalUtils ADTokenCacheStoreItemToDictionary:obj.tokenCacheItem] : [RNAdalUtils ADAuthenticationErrorToDictionary:obj.error];
...
+ (NSMutableDictionary *)ADTokenCacheStoreItemToDictionary:(ADTokenCacheItem *)obj
{
  ...
  {
    [dict setObject:[RNAdalUtils ADUserInformationToDictionary:obj.userInformation] forKey:@"userInfo"];
